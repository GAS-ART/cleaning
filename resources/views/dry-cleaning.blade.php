            ...
            <div class="stages-row">
               <div class="stages-item">
                  <div class="stages-item-row">
                     ...
                     <div class="stages-item-img">
                        <img src="{{ asset('img/stages/dry_clining/dry_clining-1.jpg') }}" alt="Химчистка мебели итальянской эко химией. Клининг - Химчистка любой мягкой мебели" title="Химчистка диванов, кресел, ковров и любой мягкой мебели">
                     </div>
               ...
               <div class="stages-item">
                  <div class="stages-item-row">
                     ...
                     <div class="stages-item-img">
                        <img src="{{ asset('img/stages/dry_clining/dry_clining-2.jpg') }}" alt="Удаление любых видов грязи и пятен с мягкой мебели. Клининг - Химчистка любой мягкой мебели" title="Химчистка диванов, кресел, ковров и любой мягкой мебели">>
                     </div>
                     <div class="stages-item-description">
               ...
               <div class="stages-item">
                  <div class="stages-item-row">
                     ...
                     <div class="stages-item-img">
                        <img src="{{ asset('img/stages/dry_clining/dry_clining-3.jpg') }}" alt="Химчистка мебели - удаление самых сложных пятен. Клининг - Химчистка любой мягкой мебели" title="Химчистка диванов, кресел, ковров и любой мягкой мебели">>
                     </div>
                     <div class="stages-item-description">
               ...
               <div class="stages-item">
                  <div class="stages-item-row">
                     ...
                     <div class="stages-item-img correct-img">
                        <img src="{{ asset('img/stages/dry_clining/dry_clining-4.jpg') }}" alt="Химчистка мебели - чистим от грязные диваны и кресла. Клининг - Химчистка любой мягкой мебели" title="Химчистка диванов, кресел, ковров и любой мягкой мебели">>
                     </div>
                     <div class="stages-item-description">
               ...
               <div class="stages-item">
                  <div class="stages-item-row">
                     ...
                     <div class="stages-item-img">
                        <img src="{{ asset('img/stages/dry_clining/dry_clining-5.jpg') }}" alt="Сушим мебель после химчистки. Клининг - Химчистка любой мягкой мебели" title="Химчистка диванов, кресел, ковров и любой мягкой мебели">>
                     </div>
                     <div class="stages-item-description">
