            ...
            <div class="stages-row">
               <div class="stages-item">
                  <div class="stages-item-row">
                     ...
                     <div class="stages-item-img">
                        <img src="{{ asset('img/stages/spring_clining/1.jpg') }}" alt="">
                     </div>
                     <div class="stages-item-description">
                        <p>С шкафом, полок снимаем и вынимаем содержимое, протираем  все полки и ящики, паутинки под потолком, если они есть. Протираем  подоконники и батареи, осветительные приборы и мебель. Так же рамы картин и фотографий. Мелкие предметы  обрабатываем  по одному.  Полируем  деревянные части мебели специальным средствам. Так же не забываем о чистоте комнатных растений: тщательно протрите от пыли крупнолистные, а цветы с мелкими листочками отправьте под душ. Соберем весь мусор в доме (пустые баночки в ванной, порванные носки, поломанные и просто устаревшие вещи).</p>
                     </div>
                  </div>
               </div>
               <div class="stages-item">
                  <div class="stages-item-row">
                     ...
                     <div class="stages-item-img">
                        <img src="{{ asset('img/stages/spring_clining/2.jpg') }}" alt="">
                     </div>
                     <div class="stages-item-description">
               ...
               <div class="stages-item">
                  <div class="stages-item-row">
                     ...
                     <div class="stages-item-img">
                        <img src="{{ asset('img/stages/spring_clining/4.jpg') }}" alt="">
                     </div>
                     <div class="stages-item-description">
               ...
               <div class="stages-item">
                  <div class="stages-item-row">
                     ...
                     <div class="stages-item-img">
                        <img src="{{ asset('img/stages/spring_clining/5.jpg') }}" alt="">
                     </div>
                     <div class="stages-item-description">
