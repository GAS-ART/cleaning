   ...
   <div class="stages">
      <div class="container">
         <div class="stages-title">
            ...
            Компания <span class="about-text-span">«Клининг.UA»</span> – поддерживает чистоту в десятках коммерческих и частых помещениях
 работаем в удобное время для вас. Наш опыт, оборудование позволяет сделать работу быстро и качественно. Генеральная уборка производится для обновления внешнего вида помещения после длительного использования,  после переезда, при подготовке к сдаче или в рамках предпродажной подготовки. Работаем 7 дней в неделю 24 часа в сутки.
         </div>
         </div>
